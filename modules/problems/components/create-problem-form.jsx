...
const sampledpData = {
  ...
  editorial:
    "This is a classic dynamic programming problem. The number of ways to reach the nth step is the sum of the ways to reach (n-1) and (n-2), forming a Fibonacci-like sequence.",
  testCases: [
    { input: "2", output: "2" },
    { input: "3", output: "3" },
    { input: "4", output: "5" },
  ...
  examples: {
    ...
    JAVA: {
      ...
      output: "5",
      explanation:
        "There are five possible combinations of 1 and 2 steps.",
    },
  },

  // 🔥 STARTER CODE (prints output)
  codeSnippets: {
    JAVASCRIPT: `/**
 * @param {number} n
 * @return {number}
...
class Main {
  ...
  // 🔥 REFERENCE SOLUTIONS (prints output)
  referenceSolutions: {
